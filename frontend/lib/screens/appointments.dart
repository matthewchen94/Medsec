...
//                               .add(Duration(minutes: event.duration ?? 0))),
//                           style:
...
//   //   var m = _doctors.length;
//   //   var i = 0;
//   //   var name;
//   //   for (i = 0; i < m; i++) {
//   //     if (_doctors[i].id == _appointmentState.did) name = _doctors[i].name;
//   //   }
//   //   return name;
//   // }
...
//          backgroundColor: Color(0x44000000),
                    ...
                    .map((event) => Container(
                        ...
                        child: (event is Appointment)
                            ? ListTile(
                                ...
                                // title: Text(event.title),
                                title: Text(getdoctorname(event)),
                                trailing: event.status == 'UNCONFIRMED'
                                    ? Column(children: <Widget>[
                                        //event.status=='CONFIRMED' ?
                                        Icon(Icons.error,
  ...
  String getdoctorname(element) {
    var m = _doctors.length;
    var i = 0;
    var j = 0;
    var name;
    for (i = 0; i < m; i++) {
      if (_doctors[i].id == element.did) name = _doctors[i].name;
    }
    return name;
  }
}
